...
SOURCES = \
	__init__.py \
	crs_guesser.py crs_guesser_dialog.py

PLUGINNAME = crs_guesser

PY_FILES = \
	__init__.py \
	crs_guesser.py crs_guesser_dialog.py

UI_FILES = crs_guesser_dialog_base.ui
...
QGISDIR=C:\Users\Brigit\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
